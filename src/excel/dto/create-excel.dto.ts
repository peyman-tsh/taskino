...
export class CreateExcelDto {
  @ApiProperty({
    description: 'ID of the user who uploaded/downloaded the file',
  ...
  @ApiPropertyOptional({
    description: 'Related leave request ID',
